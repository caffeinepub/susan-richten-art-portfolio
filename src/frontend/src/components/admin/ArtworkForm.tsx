...
export default function ArtworkForm({
  ...
  async function handleAdditionalImageChange(
    e: React.ChangeEvent<HTMLInputElement>,
  ) {
    ...
    setForm((f) => ({
      ...f,
      additionalImages: [...f.additionalImages, ...dataUrls],
    }));
    e.target.value = "";
  }
  ...
  const inputClass =
    "w-full px-3 py-2 border border-sand/60 rounded-sm bg-warm-white text-charcoal text-sm focus:outline-none focus:border-gold";
  const labelClass =
    "block text-xs font-medium text-charcoal-muted uppercase tracking-wide mb-1";
        ...
        <div className="p-6 space-y-4">
          <div className="grid grid-cols-2 gap-4">
            <div className="col-span-2">
              <label htmlFor="artwork-title" className={labelClass}>
                Title
              </label>
              <input
                id="artwork-title"
            ...
            <div>
              <label htmlFor="artwork-year" className={labelClass}>
                Year
              </label>
              <input
                id="artwork-year"
            ...
            <div>
              <label htmlFor="artwork-category" className={labelClass}>
                Category
              </label>
              <input
                id="artwork-category"
            ...
            <div>
              <label htmlFor="artwork-medium" className={labelClass}>
                Medium
              </label>
              <input
                id="artwork-medium"
            ...
            <div>
              <label htmlFor="artwork-size" className={labelClass}>
                Size
              </label>
              <input
                id="artwork-size"
            ...
            <div className="col-span-2">
              <label htmlFor="artwork-location" className={labelClass}>
                Location
              </label>
              <input
                id="artwork-location"
            ...
            <div className="col-span-2">
              <label htmlFor="artwork-primary-image-btn" className={labelClass}>
                Primary Image
              </label>
            ...
            <div className="col-span-2">
              <label htmlFor="artwork-description" className={labelClass}>
                Description
              </label>
              <textarea
          ...
          <div>
            <label
              htmlFor="artwork-additional-photos-btn"
            ...
            {form.additionalImages.length > 0 && (
              <div className="grid grid-cols-4 gap-2 mb-3">
                {form.additionalImages.map((img, i) => (
                  <div key={img || `img-${i}`} className="relative group/thumb">
                    <img
                      src={img}
                      alt={`Additional ${i + 1}`}
