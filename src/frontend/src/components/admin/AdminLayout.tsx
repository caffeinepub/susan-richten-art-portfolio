  ...
  const SidebarContent = () => (
    <div className="flex flex-col h-full">
      <div className="p-6 border-b border-sidebar-border">
        <h1 className="font-heading text-xl text-sidebar-foreground">
          Admin Panel
        </h1>
        <p className="font-body text-xs text-sidebar-foreground/60 mt-0.5 tracking-widest uppercase">
          Content Manager
        </p>
      </div>
    ...
    <div className="flex h-screen bg-beige overflow-hidden">
      ...
      {sidebarOpen && (
        <div className="fixed inset-0 z-50 md:hidden">
          {/* biome-ignore lint/a11y/useKeyWithClickEvents: overlay backdrop, ESC key handled globally */}
          <div
