  ...
  const addMilestone = () => {
    ...
    const nextId =
      careerMilestones.length > 0
        ? Math.max(...careerMilestones.map((m) => m.id)) + 1
        : 1;
  ...
  const addPressLink = () => {
    ...
    const nextId =
      pressMentions.length > 0
        ? Math.max(...pressMentions.map((p) => p.id)) + 1
        : 1;
  ...
  return (
    <div className="space-y-8">
      ...
      <div className="space-y-4">
        ...
        <div>
          <label
            htmlFor="about-artist-statement"
            className="block text-sm font-medium text-charcoal mb-1"
          >
            Artist Statement
          </label>
          <textarea
            id="about-artist-statement"
      ...
      <div className="space-y-3">
        ...
        <div className="flex gap-2">
          <input
            ...
            onChange={(e) =>
              setNewMilestone((p) => ({ ...p, year: e.target.value }))
            }
            placeholder="Year"
          ...
          <input
            ...
            onChange={(e) =>
              setNewMilestone((p) => ({ ...p, event: e.target.value }))
            }
      ...
      <div className="space-y-3">
        ...
        <ul className="space-y-2">
          {pressMentions.map((m) => (
            ...
            >
              <span>
                <strong>{m.publication}</strong> — {m.headline || m.date}
              </span>
              <button
                type="button"
        ...
        <div className="grid grid-cols-2 gap-2">
          <input
            ...
            onChange={(e) =>
              setNewPressLink((p) => ({ ...p, publication: e.target.value }))
            }
          ...
          <input
            ...
            onChange={(e) =>
              setNewPressLink((p) => ({ ...p, headline: e.target.value }))
            }
          ...
          <input
            ...
            onChange={(e) =>
              setNewPressLink((p) => ({ ...p, date: e.target.value }))
            }
          ...
          <input
            ...
            onChange={(e) =>
              setNewPressLink((p) => ({ ...p, url: e.target.value }))
            }
            placeholder="URL"
            className="border border-stone/30 rounded px-2 py-1.5 text-sm focus:outline-none focus:ring-1 focus:ring-gold"
          />
          <textarea
            ...
            onChange={(e) =>
              setNewPressLink((p) => ({ ...p, excerpt: e.target.value }))
            }
            placeholder="Excerpt"
            rows={2}
