...
const defaultSiteSettings: SiteSettings = {
  ...
  seoSettings: [
    {
      page: "home",
      title: "Susan Richten | Fine Art",
      description: "Fine art by Susan Richten",
      keywords: "art, painting, fine art",
    },
    {
      page: "gallery",
      title: "Gallery | Susan Richten",
      description: "Browse artworks by Susan Richten",
      keywords: "gallery, artworks",
    },
    {
      page: "about",
      title: "About | Susan Richten",
      description: "About Susan Richten",
      keywords: "about, artist",
    },
    {
      page: "commissions",
      title: "Commissions | Susan Richten",
      description: "Commission a custom artwork",
      keywords: "commissions, custom art",
    },
    {
      page: "contact",
  ...
  aboutBio:
    "Susan Richten is a contemporary fine artist known for her evocative landscapes and portraits.",
  artistStatement:
    "My work explores the interplay between light and shadow, capturing fleeting moments of beauty in the everyday world.",
  heroArtistName: "Susan Richten",
  heroTagline: "Fine Art & Commissions",
  heroIntroText:
    "Welcome to my studio. I create original paintings and accept commissions for custom artwork.",
  commissionHeroText:
    "Commission a unique, original artwork created just for you.",
  commissionPricingText:
    "Pricing varies based on size, medium, and complexity. Contact me for a custom quote.",
};
...
const defaultTestimonials: Testimonial[] = [
  {
    id: 1,
    quote:
      "Susan's work is absolutely breathtaking. The commissioned piece she created for our home is a true masterpiece.",
    name: "Emily Johnson",
  ...
  },
  {
    id: 2,
    quote:
      "Working with Susan was a wonderful experience. She captured exactly what I envisioned.",
    name: "Michael Chen",
...
const defaultPressMentions: PressMention[] = [
  {
    ...
    url: "#",
    excerpt:
      "Susan Richten's luminous landscapes have captured the attention of collectors worldwide.",
  },
];
...
const defaultProcessSteps: ProcessStep[] = [
  ...
  },
  {
    ...
    description: "I create a detailed proposal with sketches and pricing.",
  },
  {
    id: 3,
    stepNumber: 3,
    title: "Creation",
    description:
      "I bring your vision to life with careful attention to detail.",
  },
  {
    id: 4,
    stepNumber: 4,
...
const defaultFAQItems: FAQItem[] = [
  {
    ...
    answer: "Typically 4-8 weeks depending on size and complexity.",
  },
  {
    id: 2,
    question: "What is your pricing?",
    answer:
      "Pricing varies based on size, medium, and complexity. Please contact me for a quote.",
  },
  {
    id: 3,
    question: "Do you ship internationally?",
    answer:
      "Yes, I ship worldwide with careful packaging to ensure safe delivery.",
  },
];
...
const defaultCareerMilestones: CareerMilestone[] = [
  {
    id: 1,
    year: "2015",
    event: "Graduated with MFA from the Academy of Fine Arts",
  },
  {
    id: 2,
    year: "2017",
    event: "First solo exhibition at the Downtown Gallery",
  },
  {
    id: 3,
    year: "2020",
    event: 'Featured in Art Today Magazine\'s "Artists to Watch"',
  },
  {
    id: 4,
    year: "2022",
    event: "International exhibition in Paris and London",
  },
];
...
interface CMSContextType {
  ...
  addCommissionInquiry: (
    inquiry: Omit<CommissionInquiry, "id" | "timestamp" | "status">,
  ) => void;
  updateCommissionInquiryStatus: (id: number, status: string) => void;
  updateCommissionInquiry: (
    id: number,
    updates: Partial<CommissionInquiry>,
  ) => void;

  // Contact Inquiries
  addContactInquiry: (
    inquiry: Omit<ContactInquiry, "id" | "timestamp" | "status">,
  ) => void;
...
export function CMSProvider({ children }: { children: React.ReactNode }) {
  ...
  const [testimonials, setTestimonialsState] =
    useState<Testimonial[]>(defaultTestimonials);
  const [pressMentions, setPressMentionsState] =
    useState<PressMention[]>(defaultPressMentions);
  const [commissionInquiries, setCommissionInquiries] = useState<
    CommissionInquiry[]
  >([]);
  ...
  const loadFromBackend = useCallback(async () => {
    ...
    if (data.pressMentions.length > 0)
      setPressMentionsState(data.pressMentions);
    if (data.commissionInquiries.length > 0)
      setCommissionInquiries(data.commissionInquiries);
    if (data.contactInquiries.length > 0)
    ...
    if (data.careerMilestones.length > 0)
      setCareerMilestones(data.careerMilestones);
  ...
  // biome-ignore lint/correctness/useExhaustiveDependencies: loadFromBackend is defined in outer scope, stable
  useEffect(() => {
    let cancelled = false;
    let attempts = 0;
  ...
  // biome-ignore lint/correctness/useExhaustiveDependencies: nextId is a stable utility
  const addArtwork = useCallback(
    (artwork: Omit<Artwork, "id">) => {
      setArtworks((prev) => {
        ...
        backend
          .saveArtworks(next)
          .catch((e) => console.error("addArtwork save failed:", e));
        return next;
      });
    },
    [backend],
  ...
  const updateArtwork = useCallback(
    (artwork: Artwork) => {
      setArtworks((prev) => {
        ...
        backend
          .saveArtworks(next)
          .catch((e) => console.error("updateArtwork save failed:", e));
        return next;
      });
    },
    [backend],
  ...
  const deleteArtwork = useCallback(
    (id: number) => {
      setArtworks((prev) => {
        ...
        backend
          .saveArtworks(next)
          .catch((e) => console.error("deleteArtwork save failed:", e));
        return next;
      });
    },
    [backend],
    ...
    (testimonial: Omit<Testimonial, "id">) => {
      setTestimonialsState((prev) => {
        ...
        backend
          ...
          .catch((e) => console.error("addTestimonial save failed:", e));
        return next;
      });
    },
    [backend],
  ...
  const updateTestimonial = useCallback(
    (testimonial: Testimonial) => {
      setTestimonialsState((prev) => {
        ...
        backend
          .saveTestimonials(next)
          .catch((e) => console.error("updateTestimonial save failed:", e));
        return next;
      });
    },
    [backend],
  ...
  const deleteTestimonial = useCallback(
    (id: number) => {
      setTestimonialsState((prev) => {
        ...
        backend
          .saveTestimonials(next)
          .catch((e) => console.error("deleteTestimonial save failed:", e));
        return next;
      });
    },
    [backend],
  ...
  const setTestimonials = useCallback(
    (testimonials: Testimonial[]) => {
      ...
      backend
        ...
        .catch((e) => console.error("setTestimonials save failed:", e));
    },
    [backend],
  );
  ...
  const addPressMention = useCallback(
    (mention: Omit<PressMention, "id">) => {
      setPressMentionsState((prev) => {
        const next = [...prev, { ...mention, id: nextId(prev) }];
        backend
          .savePressMentions(next)
          .catch((e) => console.error("addPressMention save failed:", e));
        return next;
      });
    },
    [backend],
  ...
  const updatePressMention = useCallback(
    (mention: PressMention) => {
      setPressMentionsState((prev) => {
        const next = prev.map((p) => (p.id === mention.id ? mention : p));
        backend
          .savePressMentions(next)
          .catch((e) => console.error("updatePressMention save failed:", e));
        return next;
      });
    },
    [backend],
  ...
  const deletePressMention = useCallback(
    (id: number) => {
      setPressMentionsState((prev) => {
        const next = prev.filter((p) => p.id !== id);
        backend
          .savePressMentions(next)
          .catch((e) => console.error("deletePressMention save failed:", e));
        return next;
      });
    },
    [backend],
  ...
  const setPressMentions = useCallback(
    (mentions: PressMention[]) => {
      setPressMentionsState(mentions);
      backend
        .savePressMentions(mentions)
        .catch((e) => console.error("setPressMentions save failed:", e));
    },
    [backend],
  );
  ...
  // biome-ignore lint/correctness/useExhaustiveDependencies: nextId is a stable utility
  const addCommissionInquiry = useCallback(
    (inquiry: Omit<CommissionInquiry, "id" | "timestamp" | "status">) => {
      setCommissionInquiries((prev) => {
        ...
        backend
          .saveCommissionInquiries(next)
          .catch((e) => console.error("addCommissionInquiry save failed:", e));
        return next;
      });
    },
    [backend],
  ...
  const updateCommissionInquiryStatus = useCallback(
    (id: number, status: string) => {
      setCommissionInquiries((prev) => {
        ...
        backend
          .saveCommissionInquiries(next)
          .catch((e) =>
            console.error("updateCommissionInquiryStatus save failed:", e),
          );
        return next;
      });
    },
  ...
  const updateCommissionInquiry = useCallback(
    (id: number, updates: Partial<CommissionInquiry>) => {
      setCommissionInquiries((prev) => {
        const next = prev.map((c) => (c.id === id ? { ...c, ...updates } : c));
        backend
          .saveCommissionInquiries(next)
          .catch((e) =>
            console.error("updateCommissionInquiry save failed:", e),
          );
        return next;
      });
    },
  ...
  // biome-ignore lint/correctness/useExhaustiveDependencies: nextId is a stable utility
  const addContactInquiry = useCallback(
    (inquiry: Omit<ContactInquiry, "id" | "timestamp" | "status">) => {
      setContactInquiries((prev) => {
        ...
        backend
          ...
          .catch((e) => console.error("addContactInquiry save failed:", e));
        return next;
      });
    },
    [backend],
  ...
  const addNotification = useCallback(
    (notification: Omit<Notification, "id" | "timestamp">) => {
      setNotifications((prev) => {
        const next = [
          ...prev,
          { ...notification, id: nextId(prev), timestamp: Date.now() },
        ];
        backend
          .saveNotifications(next)
          .catch((e) => console.error("addNotification save failed:", e));
        return next;
      });
    },
    [backend],
    ...
    (id: number, status: string) => {
      setNotifications((prev) => {
        ...
        backend
          .saveNotifications(next)
          .catch((e) =>
            console.error("updateNotificationStatus save failed:", e),
          );
        return next;
      });
    },
  ...
  const markNotificationRead = useCallback(
    (id: number) => {
      setNotifications((prev) => {
        ...
        backend
          .saveNotifications(next)
          .catch((e) => console.error("markNotificationRead save failed:", e));
        return next;
      });
    },
    [backend],
  ...
  const markNotificationResponded = useCallback(
    (id: number) => {
      setNotifications((prev) => {
        const next = prev.map((n) =>
          n.id === id ? { ...n, status: "responded" } : n,
        );
        backend
          .saveNotifications(next)
          .catch((e) =>
            console.error("markNotificationResponded save failed:", e),
          );
        return next;
      });
    },
  ...
  const deleteNotification = useCallback(
    (id: number) => {
      setNotifications((prev) => {
        ...
        backend
          .saveNotifications(next)
          .catch((e) => console.error("deleteNotification save failed:", e));
        return next;
      });
    },
    [backend],
  ...
  const addBlogPost = useCallback(
    (post: Omit<BlogPost, "id">) => {
      setBlogPosts((prev) => {
        ...
        backend
          .saveBlogPosts(next)
          .catch((e) => console.error("addBlogPost save failed:", e));
        return next;
      });
    },
    [backend],
  ...
  const updateBlogPost = useCallback(
    (post: BlogPost) => {
      setBlogPosts((prev) => {
        ...
        backend
          .saveBlogPosts(next)
          .catch((e) => console.error("updateBlogPost save failed:", e));
        return next;
      });
    },
    [backend],
  ...
  const deleteBlogPost = useCallback(
    (id: number) => {
      setBlogPosts((prev) => {
        ...
        backend
          .saveBlogPosts(next)
          .catch((e) => console.error("deleteBlogPost save failed:", e));
        return next;
      });
    },
    [backend],
  ...
  const updateFAQItems = useCallback(
    (items: FAQItem[]) => {
      ...
      backend
        .saveFAQItems(items)
        .catch((e) => console.error("updateFAQItems save failed:", e));
    },
    [backend],
  );
  ...
  const updateProcessSteps = useCallback(
    (steps: ProcessStep[]) => {
      setProcessSteps(steps);
      backend
        .saveProcessSteps(steps)
        .catch((e) => console.error("updateProcessSteps save failed:", e));
    },
    [backend],
  );
  ...
  const updateCareerMilestones = useCallback(
    (milestones: CareerMilestone[]) => {
      setCareerMilestones(milestones);
      backend
        .saveCareerMilestones(milestones)
        .catch((e) => console.error("updateCareerMilestones save failed:", e));
    },
    [backend],
  );
    ...
    (partial: Partial<SiteSettings>) => {
      setSiteSettings((prev) => {
        ...
        backend
          ...
          .catch((e) => console.error("updateSiteSettings save failed:", e));
        return next;
      });
    },
    [backend],
  ...
  const updateNavigationItems = useCallback(
    (items: NavigationItem[]) => {
      ...
      backend
        ...
        .catch((e) => console.error("updateNavigationItems save failed:", e));
    },
    [backend],
  );
