...
export function Contact() {
  ...
  const igUrl =
    siteSettings.socialPlatforms.find(
      (p) => p.icon === "instagram" || p.name.toLowerCase() === "instagram",
    )?.url || "";
  const fbUrl =
    siteSettings.socialPlatforms.find(
      (p) => p.icon === "facebook" || p.name.toLowerCase() === "facebook",
    )?.url || "";
  const ptUrl =
    siteSettings.socialPlatforms.find(
      (p) => p.icon === "pinterest" || p.name.toLowerCase() === "pinterest",
    )?.url || "";
          ...
          <div className="space-y-8">
            ...
            <div
              ...
              style={{
                ...
                backgroundImage:
                  "repeating-linear-gradient(45deg, oklch(0.93 0.022 80) 0px, oklch(0.93 0.022 80) 1px, transparent 1px, transparent 12px)",
              }}
            >
              <div className="absolute inset-0 flex flex-col items-center justify-center gap-2">
                <span className="font-heading text-xl italic text-charcoal-light select-none">
                  Map
                </span>
              ...
              <div className="flex flex-col gap-3">
                ...
                >
                  ...
                  {igUrl ? (
                    ...
                    <MissingInfoText className="text-xs" />
                  )}
                </a>
                <a
                  href={fbUrl || "#"}
