    ...
    <div className="page-transition">
      ...
      <section className="section-padding bg-beige">
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-12">
            <h2 className="font-heading text-4xl md:text-5xl text-charcoal mb-3">
              Featured Works
            </h2>
      ...
      <section className="section-padding bg-charcoal text-center">
        <div className="max-w-xl mx-auto">
          <h2 className="font-heading text-3xl md:text-4xl text-beige mb-4">
            Stay Connected
          </h2>
          <p className="font-body text-sm text-beige/70 mb-8">
            Be the first to know about new works, exhibitions, and commission
            availability.
          </p>
          <div className="flex gap-0 max-w-sm mx-auto">
            <input
              type="email"
              placeholder={
                siteSettings.newsletterPlaceholder || "Enter your email"
              }
              className="flex-1 px-4 py-3 bg-white text-charcoal font-body text-sm focus:outline-none"
            />
            <button
              type="button"
              className="px-6 py-3 bg-gold text-white font-body text-sm tracking-widest uppercase hover:bg-gold/90 transition-colors"
            >
              Subscribe
            </button>
          </div>
