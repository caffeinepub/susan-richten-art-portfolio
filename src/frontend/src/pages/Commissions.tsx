...
export function Commissions() {
  ...
  const { artworks, siteSettings, processSteps, faqItems, isLoading } =
    useCMS();
    ...
    <div className="page-transition pt-20">
      ...
      <section className="py-20 px-4 bg-charcoal text-center">
        <div className="max-w-3xl mx-auto">
          <h1 className="font-heading text-5xl md:text-6xl text-beige mb-6">
            ...
            {isLoading ? (
              <div className="space-y-3">
                {[1, 2, 3].map((i) => (
                  <div
                    key={i}
                    className="h-12 bg-beige-dark rounded animate-pulse"
                  />
                ))}
              </div>
            ) : (
