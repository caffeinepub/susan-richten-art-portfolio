...
export default function MessagesInbox() {
  const { notifications, updateNotificationStatus, deleteNotification } =
    useCMS();
                ...
                >
                  ...
                  <div className="flex-1 min-w-0">
                    <div className="flex items-center gap-2 mb-0.5 flex-wrap">
                      ...
                      <span
                        className={`px-2 py-0.5 rounded-sm text-xs font-medium ${sourceBadge(notification.sourceType)}`}
                      >
                        {notification.sourceType}
                      </span>
                      <span
                        className={`px-2 py-0.5 rounded-sm text-xs font-medium ${statusBadge(notification.status)}`}
                      >
                        {notification.status}
                      </span>
                    </div>
                  ...
                  <div className="shrink-0 flex items-center gap-3">
                    <span className="font-body text-xs text-charcoal-muted hidden sm:block">
