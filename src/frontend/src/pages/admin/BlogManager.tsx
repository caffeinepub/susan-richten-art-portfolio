...
import { type BlogPost, useCMS } from "../../contexts/CMSContext";
          ...
          <table className="w-full">
            <thead>
              <tr className="border-b border-beige-dark">
                <th className="px-6 py-3 text-left font-body text-xs tracking-widest uppercase text-charcoal-muted">
                  Title
                </th>
                <th className="px-6 py-3 text-left font-body text-xs tracking-widest uppercase text-charcoal-muted hidden md:table-cell">
                  Date
                </th>
                <th className="px-6 py-3 text-left font-body text-xs tracking-widest uppercase text-charcoal-muted">
                  Status
